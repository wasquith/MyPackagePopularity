...
options(repos = c(CRAN = "http://cran.rstudio.com"))
  ...
  start <- as.Date('2020-09-01'); #start <- as.Date(the.origin)
...
file <- paste0(the.pkg,"_","20191001_20200831.RData")
if(file.exists(file)) load(file) # Packages is coming back
AP <- merge(Package, AP, all=TRUE)

#Package <- AP
#save(Package, file=paste0(the.pkg,"_","20191001_20200831.RData"))

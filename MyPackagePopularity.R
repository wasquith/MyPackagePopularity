...
options(repos = c(CRAN = "http://cran.rstudio.com"))
  ...
  start <- as.Date('2020-10-02'); #start <- as.Date('2013-01-01')
  today <- as.Date('2020-10-22')
...
load("Packages_20130101_20201001.RData") # Packages is coming back
AP <- merge(Packages, AP, all=TRUE)

#Packages <- AP
#save(Packages, file="Packages_20130101_20201001.RData")

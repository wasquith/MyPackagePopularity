...
options(repos = c(CRAN = "http://cran.rstudio.com"))
  ...
  start <- as.Date('2022-03-06'); #start <- as.Date('2013-01-01')
...
load("Packages_20130101_20220305.RData") # Packages is coming back
AP <- merge(Packages, AP, all=TRUE)

#Packages <- AP
#save(Packages, file="Packages_20130101_20220305.RData")

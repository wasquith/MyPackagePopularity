...
options(repos = c(CRAN = "http://cran.rstudio.com"))
  ...
  start <- as.Date('2019-07-01'); #start <- as.Date('2013-01-01')
  today <- as.Date('2019-07-04')
...
load("Packages_20130101_20190630.RData") # Packages is coming back
AP <- merge(Packages, AP, all=TRUE)

#Packages <- AP
#save(Packages, file="Packages_20130101_20190630.RData")
